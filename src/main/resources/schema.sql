CREATE TABLE product (
                         product_id      BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,  -- 상품 ID (PK, Auto Increment)
...
CREATE TABLE brand (
                       brand_id        BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,  -- 브랜드 ID (PK, Auto Increment)
...
CREATE TABLE category (
                          category_id     BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,  -- 카테고리 ID (PK, Auto Increment)
